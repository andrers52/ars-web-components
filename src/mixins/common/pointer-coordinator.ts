...
class PointerCoordinator {
  ...
  static _preventScrolling() {
    ...
    (this as any)._scrollPreventionHandler = preventScroll;
  ...
  static _allowScrolling() {
    ...
    if (this._scrollPreventionEnabled) {
      document.removeEventListener('touchmove', this._scrollPreventionEnabled);
      document.removeEventListener('wheel', (this as any)._scrollPreventionHandler);
